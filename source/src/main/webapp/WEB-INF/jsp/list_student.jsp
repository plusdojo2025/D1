	...
	<main>
		<form action="EditAllStudentServlet.java">
			...
			<select name="grede">
				...
				<option value="firstclass">現代文</option>
				<option value="secondclass">古典</option>
				<option value="thirdclass">数学IA</option>
				<option value="thirdclass">数学ⅡB</option>
				<option value="thirdclass">数学ⅢC</option>
				<option value="thirdclass">英語表現</option>
				<option value="thirdclass">コミュニケーション英語</option>
				<option value="thirdclass">物理</option>
				<option value="thirdclass">化学</option>
				<option value="thirdclass">生物</option>
				<option value="thirdclass">地学</option>
